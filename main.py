...
class MyCalculator:
    def __init__(self):
        ...
        self.button = tk.Button(self.root, text="-", height=1, width=4 ,font=('Arial', 18))
        self.button.place(x=230, y=150)

        self.button = tk.Button(self.root, text="+", height=1, width=4 ,font=('Arial', 18))
        self.button.place(x=230, y=200)
        ...
        self.button.place(x=155, y=200)

        self.button = tk.Button(self.root, text="0", height=1, width=9 ,font=('Arial', 18))
        self.button.place(x=5, y=250)

        self.button = tk.Button(self.root, text=".", height=1, width=4 ,font=('Arial', 18))
        self.button.place(x=155, y=250)
